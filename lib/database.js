...
export function createOrUpdateConversation(convKey, apiKeyHash, qwenChatId, accountId, messageCount, lastMsgId, lastUserMsgId) {
  const insertOrReplace = db.prepare(`
    INSERT INTO conversations (conv_key, api_key_hash, qwen_chat_id, account_id, message_count, last_msg_id, last_user_msg_id, last_used)
  ...
  `);
  insertOrReplace.run(convKey, apiKeyHash, qwenChatId, accountId, messageCount, lastMsgId, lastUserMsgId || null);
}
